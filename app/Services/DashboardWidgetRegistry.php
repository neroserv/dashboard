...
class DashboardWidgetRegistry
{
    ...
    public static function widgets(): array
    {
        $widgets = [
            ...
            ['key' => 'action-items', 'title' => 'Zu erledigen', 'description' => 'Rechnungen, Mahnungen', 'defaultW' => 6, 'defaultH' => 3, 'demoData' => ['overdueOrFailedInvoices' => [], 'openDunningInvoices' => []]],
            ['key' => 'global-search', 'title' => 'Globale Suche', 'description' => 'Kunden, Rechnungen durchsuchen', 'defaultW' => 6, 'defaultH' => 1],
            ['key' => 'recent-items', 'title' => 'Zuletzt angesehen', 'description' => 'Kunden (localStorage)', 'defaultW' => 4, 'defaultH' => 1],
    ...
    public static function defaultLayout(): array
    {
        $rows = [
            ...
            ['i' => 'customers-total', 'x' => 6, 'y' => 1, 'w' => 2, 'h' => 1],
