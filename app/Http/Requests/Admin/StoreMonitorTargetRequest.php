...
class StoreMonitorTargetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->input('type') === MonitorTarget::TYPE_HTTP_URL) {
        ...
        if ($this->input('type') === MonitorTarget::TYPE_TCP_PORT) {
    ...
    {
        if ($this->has('is_enabled') && $this->input('is_enabled') === null) {
