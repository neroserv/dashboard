<!-- Admin: Hosting-Server bearbeiten -->
...
<template>
    <AdminLayout :key="hostingServer.id" :breadcrumbs="breadcrumbs">
        ...
        <BRow>
            <BCol>
                <div class="mb-3">
                    <h4 class="mb-1">Hosting-Server bearbeiten</h4>
                    <p class="text-muted small mb-0">{{ hostingServer.hostname }}</p>
                </div>
                ...
                <BCard no-body>
                    ...
                    >
                        <BCardBody>
                            ...
                            <BFormGroup v-if="showPleskFields" label="Bind-Zone (.bind)" label-for="bind_zone_content">
                                <BFormTextarea
                                    ...
                                    rows="12"
                                    :model-value="hostingServer.bind_zone_content ?? ''"
                                    placeholder="$ORIGIN meinedomain.de.&#10;$TTL 86400&#10;..."
                                    class="font-monospace small"
                                    :aria-invalid="!!errors.bind_zone_content"
                                />
                                <p class="text-muted small mb-0 mt-1">
                        ...
                        <BCardFooter class="d-flex gap-2">
                            ...
                            <Link :href="hostingServersRoutes.show.url(hostingServer.id)">
