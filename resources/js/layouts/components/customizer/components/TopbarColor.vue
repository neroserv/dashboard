...
const darkImg = '/images/layouts/topbar-color-dark.png'
const gradientImg = '/images/layouts/topbar-color-gradient.png'
const grayImg = '/images/layouts/topbar-color-gray.png'
const lightImg = '/images/layouts/topbar-color-light.png'
