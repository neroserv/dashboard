        ...
        <BCard no-body class="auth-box-form border-0 mb-0">
          ...
          <BCardBody class="min-vh-100 position-relative d-flex flex-column justify-content-center">
            ...
            <div class="mt-auto">
              ...
              <BRow class="text-muted g-2">
                <BCol lg="6">
                  <button class="btn btn-default w-100">
                    Sign up with<svg xmlns="http://www.w3.org/2000/svg" class="ms-1" width="13.68px" height="14px" viewBox="0 0 256 262">
                ...
                <BCol lg="6">
                  <button class="btn btn-default w-100">
                    Sign up with<svg xmlns="http://www.w3.org/2000/svg" class="ms-1" width="14px" height="14px" viewBox="0 0 64 64">
                      <path
                        fill="currentColor"
              ...
              <BForm class="mt-4">
                <div class="mb-3">
                  ...
                  <div class="app-search">
                    <BFormInput type="text" :placeholder="META_DATA.username" required />
                    <Icon icon="user-circle" class="app-search-icon text-muted" />
                  </div>
                </div>
                ...
                <div class="mb-3" data-password="bar">
                  ...
                  <div class="app-search">
                    <BFormInput v-model="password" type="password" placeholder="••••••••" required />
            ...
            <p class="text-muted text-center mt-4 mb-0">
              ...
              <RouterLink to="/auth/split/sign-in" class="text-decoration-underline link-offset-3 fw-semibold"> Login </RouterLink>
            </p>
