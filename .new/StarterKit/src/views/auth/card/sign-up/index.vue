              ...
              <BCol lg="6">
                <BCardBody class="position-relative">
                  ...
                  <BForm>
                    <div class="mb-3">
                      ...
                      <div class="app-search">
                        <BFormInput type="text" id="userName" placeholder="David Dev" required />
                        <Icon icon="user" class="app-search-icon text-muted" />
                      </div>
                    </div>
                  ...
                  <p class="text-muted text-center mt-4 mb-0">
                    ...
                    <RouterLink to="/auth/card/sign-in" class="text-decoration-underline link-offset-3 fw-semibold"> Login </RouterLink>
                  </p>
