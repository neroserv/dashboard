              ...
              <BCol lg="6">
                <BCardBody class="position-relative">
                  <div class="auth-brand text-center mb-4 position-relative">
                    <AuthLogo />
                    <h4 class="fw-bold mt-3">Great to see you here 👋</h4>
                  ...
                  <BForm>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <RouterLink to="/auth/card/reset-pass" class="text-decoration-underline link-offset-3 text-muted"> Forgot Password? </RouterLink>
                    </div>
                  ...
                  <p class="text-muted text-center mt-4 mb-0">
                    New here?
                    <RouterLink to="/auth/card/sign-up" class="text-decoration-underline link-offset-3 fw-semibold"> Create an account </RouterLink>
                  </p>
...
import { BButton, BCard, BCardBody, BCol, BContainer, BForm, BFormCheckbox, BRow } from 'bootstrap-vue-next'
