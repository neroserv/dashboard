...
/**
* @see \App\Http\Controllers\CheckoutController::redirectToMollie
 * @see app/Http/Controllers/CheckoutController.php:160
 * @route '/checkout/redirect-to-mollie'
 */
export const redirectToMollie = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: redirectToMollie.url(options),
    method: 'get',
})

redirectToMollie.definition = {
    methods: ["get","head"],
 ...
 * @route '/checkout/redirect-to-mollie'
 */
redirectToMollie.url = (options?: RouteQueryOptions) => {
    return redirectToMollie.definition.url + queryParams(options)
}
 ...
 * @route '/checkout/redirect-to-mollie'
 */
redirectToMollie.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: redirectToMollie.url(options),
    method: 'get',
})
/**
 ...
 * @route '/checkout/redirect-to-mollie'
 */
redirectToMollie.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: redirectToMollie.url(options),
    method: 'head',
})
 ...
 * @route '/checkout/redirect-to-mollie'
 */
    const redirectToMollieForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: redirectToMollie.url(options),
        method: 'get',
    })
 ...
 * @route '/checkout/redirect-to-mollie'
 */
        redirectToMollieForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: redirectToMollie.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/checkout/redirect-to-mollie'
 */
        redirectToMollieForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: redirectToMollie.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    redirectToMollie.form = redirectToMollieForm
/**
...
redirectToMollie: Object.assign(redirectToMollie, redirectToMollie),
